        ...
        <Modal.Body>
          <Form>
            <Form.Group className='mb-3' controlId='supplier'>
              <Form.Label>
                Proveedor: <span className='tw-text-red-500'>*</span>
              </Form.Label>
              <Select
                isClearable
                name='supplier'
            ...
            <Form.Group className='mb-3' controlId='date_end'>
              <Form.Label>
                Fecha de vencimiento: <span className='tw-text-red-500'>*</span>
              </Form.Label>
              <Form.Control
                type='date'
                name='date_end'
            ...
            <Form.Group className='mb-3' controlId='date_start' hidden>
              <Form.Label>
                Fecha de compra: <span className='tw-text-red-500'>*</span>
              </Form.Label>
              <Form.Control
                type='date'
                name='date_start'
            ...
            <Form.Group className='mb-3' controlId='title'>
              <Form.Label>
                Titulo: <span className='tw-text-red-500'>*</span>
              </Form.Label>
              <Form.Control
                type='text'
                name='title'
            ...
            <Form.Group className='mb-3' controlId='description'>
              <Form.Label>
                Descripción: <span className='tw-text-red-500'>*</span>
              </Form.Label>
              <Form.Control
                as='textarea'
                name='description'
            ...
            <Form.Group className='mb-3' controlId='files'>
              <Form.Label>
                Subir todos los PDF: <span className='tw-text-red-500'>*</span>
              </Form.Label>
              <Form.Control
                type='file'
                name='files'
          ...
          {errorForm && (
            ...
            >
              <strong>Error de envío!.</strong> Todos los campos son
              obligatorios!
              <Button
                variant=''
                type='button'
